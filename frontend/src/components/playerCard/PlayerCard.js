        ...
        <div key={property.id}>
          <li>
            ...
            <button
              ...
              disabled={this.props.MortgageDisabled}
            >
              mortgage
            </button>
        ...
        style={{
          border: `${
            this.props.currentPlayer
              ? "2px solid " + this.props.playerColor
              : "1px solid gray"
          }`
        }}
      >
        <div
          ...
          style={{ backgroundColor: this.props.playerColor }}
        >
        ...
        <div className="FixedHeightContainer">
          <div className="player-property">
            <ul className="list-group">{this.listProperties()}</ul>
          </div>
        </div>
      </div>
    );
